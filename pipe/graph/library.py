...
class Library:
    ...
    def create_or_update_basic_template(self, path, args, outs, extension, code):
        template = templates.from_data(args, outs, extension, code)
        self.templates[path] = template
        return template

    def create_or_update_file_template(self, path, filepath):
    ...
    def rename_template(self, old_path, new_path):
        ...
        self.templates[new_path] = self.get(old_path)
